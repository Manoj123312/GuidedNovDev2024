namespace Terrasoft.Configuration
{
	...
	public class UsrRealtyEventsSchema : Terrasoft.Core.SourceCodeSchema
	{
		...
		protected override void InitializeProperties() {
			...
			UId = new Guid("caa2a809-25be-4812-b7d3-a997f63b5061");
		...
		protected virtual SchemaLocalizableString CreateValueIsTooBigLocalizableString() {
			SchemaLocalizableString localizableString = new SchemaLocalizableString() {
				UId = new Guid("4b876d2e-f994-68c6-d0a5-e7622a669d10"),
				Name = "ValueIsTooBig",
				CreatedInPackageId = new Guid("9874b775-17fc-4d2d-9d29-8861bb2bebf9"),
				CreatedInSchemaUId = new Guid("caa2a809-25be-4812-b7d3-a997f63b5061"),
				ModifiedInSchemaUId = new Guid("caa2a809-25be-4812-b7d3-a997f63b5061")
			};
		...
		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			...
			realUIds.Add(new Guid("caa2a809-25be-4812-b7d3-a997f63b5061"));
		}
